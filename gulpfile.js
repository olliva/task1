    ...
    return gulp
        ...
        .pipe(cheerio({
            run: function ($, file) {
                ...
                //example result:  c:\\WebServers\\home\\template-project-2\\www\\_assets\\img\\svg\\icon-crown-by-ps-fill.svg
...
gulp.task('watch', function () {
    ...
    //gulp.watch('_assets/img/sprite/*.png', ['sprite']).on('change', livereload.changed);

    // Watch svg images in folder and run tasks if they change
    //gulp.watch('_assets/img/svg/*.svg', ['svgstore']).on('change', livereload.changed);
});
